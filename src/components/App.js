...
function App() {
  ...
  useEffect(() => {
    fetch("https://nordtech-project-backend.onrender.com/get-cart")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://nordtech-project-backend.onrender.com/get-items")
      .then((res) => res.json())
      .then((data) => {
  ...
  const addToCart = (_id) => {
    fetch(`https://nordtech-project-backend.onrender.com/post-cart`, {
      method: "POST",
      headers: {
