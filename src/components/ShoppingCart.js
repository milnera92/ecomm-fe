...
const ShoppingCart = ({
  ...
  const deleteCart = () => {
    fetch(`https://nordtech-project-backend.onrender.com/delete-cart`, {
      method: "DELETE",
      headers: {
...
// deletes the entire collection of SAME items
  const deleteItem = (_id) => {
    fetch(`https://nordtech-project-backend.onrender.com/delete-cartItem`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const deleteOne = (_id) => {
    fetch(`https://nordtech-project-backend.onrender.com/delete-item`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
// sends order from shopping cart to order collection
  const confirmation = () => {
    fetch(`https://nordtech-project-backend.onrender.com/post-order`, {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
